  ...
  return (
    <div className="flex items-center gap-2 w-full sm:w-auto">
      ...
      <select
        ...
        className="flex-1 min-w-0 px-4 py-2.5 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all bg-white text-gray-900 shadow-sm font-medium"
      >
